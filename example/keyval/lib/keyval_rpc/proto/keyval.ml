...
type key = { key : string } [@@deriving show { with_path = false }, eq, qcheck2]
type keys = { keys : key list } [@@deriving show { with_path = false }, eq, qcheck2]
type value = { value : string } [@@deriving show { with_path = false }, eq, qcheck2]
type error = { error : string } [@@deriving show { with_path = false }, eq, qcheck2]
...
type unit_ = unit [@@deriving show { with_path = false }, eq, qcheck2]

type unit_or_error = { error : string }
[@@deriving show { with_path = false }, eq, qcheck2]
...
let quickcheck_key =
  { Pbrt_quickcheck.Type_class.type_name = "key"
  ; pp = pp_key
  ; gen = gen_key
  ; equal = equal_key
...
let quickcheck_tests_key ?gen () = Pbrt_quickcheck.Test.make ?gen quickcheck_key

let quickcheck_keys =
  { Pbrt_quickcheck.Type_class.type_name = "keys"
  ; pp = pp_keys
  ; gen = gen_keys
  ; equal = equal_keys
...
let quickcheck_tests_keys ?gen () = Pbrt_quickcheck.Test.make ?gen quickcheck_keys

let quickcheck_value =
  { Pbrt_quickcheck.Type_class.type_name = "value"
  ; pp = pp_value
  ; gen = gen_value
  ; equal = equal_value
...
let quickcheck_tests_value ?gen () = Pbrt_quickcheck.Test.make ?gen quickcheck_value

let quickcheck_error =
  { Pbrt_quickcheck.Type_class.type_name = "error"
  ; pp = pp_error
  ; gen = gen_error
  ; equal = equal_error
...
let quickcheck_tests_error ?gen () = Pbrt_quickcheck.Test.make ?gen quickcheck_error

let quickcheck_value_or_error =
  { Pbrt_quickcheck.Type_class.type_name = "value_or_error"
...
let quickcheck_keyval_pair =
  { Pbrt_quickcheck.Type_class.type_name = "keyval_pair"
  ; pp = pp_keyval_pair
  ; gen = gen_keyval_pair
...
let quickcheck_unit_ =
  { Pbrt_quickcheck.Type_class.type_name = "unit_"
  ; pp = pp_unit_
  ; gen = gen_unit_
  ; equal = equal_unit_
...
let quickcheck_tests_unit_ ?gen () = Pbrt_quickcheck.Test.make ?gen quickcheck_unit_

let quickcheck_unit_or_error =
  { Pbrt_quickcheck.Type_class.type_name = "unit_or_error"
  ; pp = pp_unit_or_error
